...
class BreezSdkSparkLib
  ...
  @override
  int get rustContentHash => 1404502095;
...
abstract class BreezSdkSparkLibApi extends BaseApi {
  ...
  void crateSdkBreezSdkDisconnect({required BreezSdk that});
  ...
  Future<InputType> crateSdkParse({required String input});
...
class BreezSdkSparkLibApiImpl extends BreezSdkSparkLibApiImplPlatform implements BreezSdkSparkLibApi {
  ...
  TaskConstMeta get kCrateSdkParseConstMeta => const TaskConstMeta(debugName: "parse", argNames: ["input"]);
  ...
  SendPaymentOptions dco_decode_send_payment_options(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 1:
        return SendPaymentOptions_Bolt11Invoice(preferSpark: dco_decode_bool(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
  ...
  SendPaymentOptions sse_decode_send_payment_options(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 1:
        ...
        return SendPaymentOptions_Bolt11Invoice(preferSpark: var_preferSpark);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  void sse_encode_send_payment_options(SendPaymentOptions self, SseSerializer serializer) {
    ...
    switch (self) {
      ...
      case SendPaymentOptions_Bolt11Invoice(preferSpark: final preferSpark):
        sse_encode_i_32(1, serializer);
